...
curl https://raw.githubusercontent.com/maus-me/arr-scripts/main/sonarr/TdarrScan.bash -o /config/extended/TdarrScan.bash 
echo "Done"

if [ ! -f /config/extended/sma.ini ]; then
	echo "Download SMA config..."
	curl https://raw.githubusercontent.com/maus-me/arr-scripts/main/sonarr/sma.ini -o /config/extended/sma.ini 
	echo "Done"
fi
...
if [ ! -f /config/extended/recyclarr.yaml ]; then
	...
	curl https://raw.githubusercontent.com/maus-me/arr-scripts/main/sonarr/recyclarr.yaml -o /config/extended/recyclarr.yaml
	echo "Done"
fi

if [ ! -f /config/extended.conf ]; then
	echo "Download Extended config..."
	curl https://raw.githubusercontent.com/maus-me/arr-scripts/main/sonarr/extended.conf -o /config/extended.conf
